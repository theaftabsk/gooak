    ...
    <div className="login-page" style={cssVariables}>
      <div className="login-card">
        <div className="login-header">
          ...
          <p className="login-subtitle">Register a new customer account to access exclusive collections and order tracking</p>
        </div>
        ...
        <div className="login-footer">
          Already have an account? <a href={searchParams.has('redirect') ? `/login?redirect=${encodeURIComponent(redirectTo)}` : "/login"} className="login-link">Sign In</a>
        </div>
      </div>
