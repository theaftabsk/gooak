...
// ─── Storefront Icon Library ──────────────────────────────────────────────────
// All inline SVGs extracted from storefront components into one central file.
// Usage: import { Icons } from '@/components/ui/Icons';  then <Icons.Search />
...
export const Icons = {
  ...
  Star: ({ filled = true }: { filled?: boolean }) => (
    <svg width="12" height="12" viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1">
      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
    </svg>
  ),
  StarLg: ({ filled = true }: { filled?: boolean }) => (
  ...
  Signal: () => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M1.75 8.75a11 11 0 0 1 20.5 0"/><path d="M5 12.5a7 7 0 0 1 14 0"/>
      <path d="M8.5 16a3.5 3.5 0 0 1 7 0"/><circle cx="12" cy="20" r="1" fill="currentColor"/>
    </svg>
  ),
  Shield: () => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  UPI: () => (
    <svg width="32" height="32" viewBox="0 0 48 48" fill="none">
      ...
      <text x="24" y="30" textAnchor="middle" fontSize="14" fontWeight="bold" fill="#15803D">UPI</text>
    </svg>
  ),
};
