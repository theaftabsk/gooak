    ...
    <div style={cssVariables} className="success-wrapper">
      <div className="success-container">
        ...
        <div className="success-action-row">
          <a href={`/track-order?order_number=${orderNumber}`} className="success-btn-track" style={{ background: theme.primaryColor || '#15803D' }}>
            📦 Track My Order
          </a>
          <a href="/products" className="success-btn-browse">
            Continue Shopping
          </a>
        </div>
